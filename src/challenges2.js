...
// Desafio 11 - Ajudado pela Bianca no plantão da manhã
function generatePhoneNumber(numeros) {
  ...
  let numPronto = '(' + numeros[0] + numeros[1] + ') ' + numeros[2] + numeros[3] + numeros[4] + numeros[5] + numeros[6] + '-' + numeros[7] + numeros[8] + numeros[9] +numeros[10];
  return numPronto;
}
